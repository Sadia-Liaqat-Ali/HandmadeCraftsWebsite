...
<div class="container">
  <a href="index.php" class="btn btn-primary mb-3">← Back to Products</a>
  <div class="row mb-4">
    <div class="col-md-5">
<img src="uploads/<?php echo $product['image']; ?>" class="img-fluid rounded" alt="" width="400" height="400">
    </div>
    <div class="col-md-7">
      ...
      <p><span class="summary-label">Artisan:</span> <?php echo $product['artisan']; ?></p>
      ...
      <a href="login.php" class="btn btn-warning mb-3">← Add To Cart</a>
</div>
  </div>
