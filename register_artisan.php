...
if (isset($_POST['register'])) {
  ...
  $sql = "INSERT INTO artisan (name, email, password, contact, skills) VALUES ('$name', '$email', '$pass', '$contact', '$skills')";
  $conn->query($sql);
  echo "<script>alert('Artisan Registered!')
...
<div class="form-box">
  ...
  <form method="post">
    ...
    <div class="mb-3"><textarea name="skills" class="form-control" placeholder="Your Skills" required></textarea></div>
